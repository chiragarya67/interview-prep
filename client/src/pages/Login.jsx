    ...
    <div className="min-h-screen flex items-center justify-center px-[16px]" style={{ background: "#0a0a0f" }}>
      <div className="w-full max-w-[420px]">
        <div className="text-center mb-[40px]">
          ...
          <h1 className="text-[28px] font-bold text-white" style={{ fontFamily: "Syne, sans-serif" }}>Welcome back</h1>
          <p className="text-gray-400 text-[14px] mt-[8px]">Sign in to continue your practice</p>
        </div>
        ...
        <div className="p-[32px] rounded-[20px]"
          ...
          <p className="text-center text-gray-400 text-[14px] mt-[24px]">
            ...
            <Link to="/register" className="text-indigo-400 hover:text-indigo-300 font-medium no-underline">
              Register
            </Link>
          </p>
        </div>
